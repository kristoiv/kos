...
enum opt_code
{
  ...
  OPT_mcmodel_ = 1153,                       /* -mcmodel= */
  OPT_mcpu_ = 1154,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1155,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1156,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1157,             /* -mgeneral-regs-only */
  OPT_mlittle_endian = 1158,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1159,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1160,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1161,            /* -mlow-precision-sqrt */
  OPT_momit_leaf_frame_pointer = 1162,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1163,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1164,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1165,          /* -msign-return-address= */
  OPT_mstrict_align = 1166,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1167,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1168,                     /* -mtls-size= */
  OPT_mtune_ = 1169,                         /* -mtune= */
  OPT_mverbose_cost_dump = 1170,             /* -mverbose-cost-dump */
  OPT_n = 1171,                              /* -n */
  ...
  OPT_s = 1203,                              /* -s */
  OPT_save_temps = 1204,                     /* -save-temps */
  OPT_save_temps_ = 1205,                    /* -save-temps= */
  OPT_shared = 1206,                         /* -shared */
  OPT_shared_libgcc = 1207,                  /* -shared-libgcc */
  /* OPT_specs = 1208, */                    /* -specs */
  OPT_specs_ = 1209,                         /* -specs= */
  OPT_static = 1210,                         /* -static */
  OPT_static_libasan = 1211,                 /* -static-libasan */
  OPT_static_libgcc = 1212,                  /* -static-libgcc */
  OPT_static_libgfortran = 1213,             /* -static-libgfortran */
  OPT_static_libgo = 1214,                   /* -static-libgo */
  OPT_static_liblsan = 1215,                 /* -static-liblsan */
  OPT_static_libmpx = 1216,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1217,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1218,               /* -static-libstdc++ */
  OPT_static_libtsan = 1219,                 /* -static-libtsan */
  OPT_static_libubsan = 1220,                /* -static-libubsan */
  /* OPT_std_c__03 = 1221, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1222, */                /* -std=c++0x */
  OPT_std_c__11 = 1223,                      /* -std=c++11 */
  OPT_std_c__14 = 1224,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1225, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1226, */                /* -std=c++1y */
  OPT_std_c__1z = 1227,                      /* -std=c++1z */
  OPT_std_c__98 = 1228,                      /* -std=c++98 */
  OPT_std_c11 = 1229,                        /* -std=c11 */
  /* OPT_std_c1x = 1230, */                  /* -std=c1x */
  /* OPT_std_c89 = 1231, */                  /* -std=c89 */
  OPT_std_c90 = 1232,                        /* -std=c90 */
  OPT_std_c99 = 1233,                        /* -std=c99 */
  /* OPT_std_c9x = 1234, */                  /* -std=c9x */
  OPT_std_f2003 = 1235,                      /* -std=f2003 */
  OPT_std_f2008 = 1236,                      /* -std=f2008 */
  OPT_std_f2008ts = 1237,                    /* -std=f2008ts */
  OPT_std_f95 = 1238,                        /* -std=f95 */
  OPT_std_gnu = 1239,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1240, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1241, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1242,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1243,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1244, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1245, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1246,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1247,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1248,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1249, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1250, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1251,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1252,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1253, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1254, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1255,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1256, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1257, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1258, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1259,                     /* -std=legacy */
  OPT_symbolic = 1260,                       /* -symbolic */
  OPT_t = 1261,                              /* -t */
  OPT_time = 1262,                           /* -time */
  OPT_time_ = 1263,                          /* -time= */
  OPT_traditional = 1264,                    /* -traditional */
  OPT_traditional_cpp = 1265,                /* -traditional-cpp */
  OPT_trigraphs = 1266,                      /* -trigraphs */
  OPT_u = 1267,                              /* -u */
  OPT_undef = 1268,                          /* -undef */
  OPT_v = 1269,                              /* -v */
  OPT_version = 1270,                        /* -version */
  OPT_w = 1271,                              /* -w */
  OPT_wrapper = 1272,                        /* -wrapper */
  OPT_x = 1273,                              /* -x */
  OPT_z = 1274,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
